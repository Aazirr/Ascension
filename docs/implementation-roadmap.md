...
- Add fonts, metadata, and Vercel Analytics.
- Create `types/index.ts` and empty JSON data files.
- Add base theme tokens in global CSS.

Exit criteria:

- Project builds cleanly.
- Core layout and font stack are visible.
